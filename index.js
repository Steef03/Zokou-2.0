"use strict";
    ...
    zk.ev.on('group-participants.update', async (group) => {
       ...
       console.log(group)
        ...
        try {
            ...
            ppgroup = 'https://telegra.ph/file/bc8300e9b121e4be5b857.jpg';
        }
    ...
    ${metadata.desc}`;
             ...
             zk.sendMessage(
                  group.id,
                  {
                    text : `@${(group.author).split("@")[0]} a enfreint la règle de l'antipromote par consequent lui et @${(group.participants[0]).split("@")[0]} ont été demis des droits d'aministration`,
